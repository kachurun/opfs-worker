...
| [Streaming](./guides/streaming.md)             | How to read/write large files without buffering           |
| [Uploading from disk](./guides/uploading.md)   | Pickers, paste, drag-and-drop into `importFiles`          |
| [Downloading to disk](./guides/downloading.md) | `readBlob` → `<a download>` / `showSaveFilePicker`        |
