...
Start with [Choosing a mode](./choosing-a-mode.md).
...
| [Pure classes](./guides/pure.md)          | `OPFSSync` / `OPFSAsync` in your own worker |
...
| Page                                      | About                                 |
| ----------------------------------------- | ------------------------------------- |
| [Create helpers](./api/create.md)         | `createOPFS*` and options             |
